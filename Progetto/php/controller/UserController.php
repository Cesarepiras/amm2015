...
/**
 * This is the controller used by the user with simple user privileges 
 *
 * @author Cesare Piras
 */
            ...
            if (isset($request["cmd"])) {
                ...
                switch ($request["cmd"]) {
                    ...
                    case 'contatti':
                        ...
                        $this->creaFeedbackUtente($msg, $vd, "Contacts updated");
                        $this->showHomeUtente($vd);
                        break;
                    ...
                    case 'a_salva':
                        ...
                        if (isset($request['modello'])) {
                            ...
                            if (isset($intVal)) {
                                ...
                                $this->creaFeedbackUtente($msg, $vd, "Model updated");
                                if (count($msg) == 0) {
                                    $vd->setSottoPagina('modelli');
                                }
                            }
                ...
                // No command, simply show the view
                $user = UserFactory::instance()->cercaUtentePerId(
                        $_SESSION[BaseController::user], $_SESSION[BaseController::role]);
                $this->showHomeUtente($vd);
            }
